...
export const clientes: Preset = {
  ...
  filas: [
    ...
    { razon: "Distribuidora Aconcagua", localidad: "Olivos", telefono: "11 4047-0277", cuit: "", compra: "", pago: "S", fecha: "5/3/26" },
    { razon: "Veterinaria del Puerto", localidad: "Olivos", telefono: "11 4047-0289", cuit: "27-12908734-5", compra: "$ 431.800", pago: "0", fecha: "12/3/26" },
    { razon: "Forrajeria el Trebol", localidad: "San Isidro", telefono: "11 4047-0241", cuit: "20-28765432-5", compra: "$ 89.750", pago: "SI", fecha: "14/01/2026" },
  ],
};
